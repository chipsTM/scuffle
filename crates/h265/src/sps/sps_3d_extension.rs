...
impl Sps3dExtension {
    pub fn parse<R: io::Read>(bit_reader: &mut BitReader<R>) -> io::Result<Self> {
        let d0 = Sps3dExtensionD0 {
            iv_di_mc_enabled_flag: bit_reader.read_bit()?,
            iv_mv_scal_enabled_flag: bit_reader.read_bit()?,
            log2_ivmc_sub_pb_size_minus3: bit_reader.read_exp_golomb()?,
        ...
        let d1 = Sps3dExtensionD1 {
            ...
            tex_mc_enabled_flag: bit_reader.read_bit()?,
            log2_texmc_sub_pb_size_minus3: bit_reader.read_exp_golomb()?,
